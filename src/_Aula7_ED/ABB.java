...
import _Aula7_ED_Completo_Ok.Node;
...
// Autor 3: <COLOQUE O SEU NOME E RA AQUI>
...
class ABB<E extends Comparable<E>> {  // Árvore Binária de Busca 
    ...
    */    
    ...
    /*
     * Atividade: Parte I
     * Solução possível para encontrar a quantidade de veículos 
     * com preço maior do que a média armazenado na árvore
    ...
    public int qtdeMaiorMediaPrecos() {
        // Deve ser desenvolvida a partir daqui.
    	// Pode ser necessário criar atributos adicionais e outros métodos
    	// Sugestão: Considere o uso dos métodos de percurso para ajudar a resolver
    	// esta atividade.
    }
       
     /*
      * Atividade: Parte II
      * Solução possível para encontrar os veículos 
      * com ano de fabricação igual a "ano" e tipo igual a "tipo"
      * passados como parâmetro.
      * Deve retornar uma String contendo todos os veículos com essas
      * características.
      * Caso tenha dúvidas, sugiro estudar o material da aula ao vivo
      * ok!
      * 
